...
public class NotRunFlatTest extends TestUtilities {
    ...
    public void NotRunFlatTest(String hybrisUsername, String hybrisPassword, String inputTireSize) throws IOException {
        ...
        for(int i=0; i<tireListFull.size(); i++) {
            ...
            Assert.assertEquals(tireProductIterate.getRunFlatTag(), notRunFlatTag, "Season verification failed!");
            log.info("Successfully verified that product "+i+"'s run-flat tag matches the expected tag of "+notRunFlatTag);
        }
    }
}
