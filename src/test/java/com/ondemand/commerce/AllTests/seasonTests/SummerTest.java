...
public class SummerTest extends TestUtilities {
    ...
    @Test
    public void summerTest() throws IOException {
        // open main page
        ...
        for(int i=0; i<tireListFull.size(); i++) {
            ...
            Assert.assertEquals(tireProductIterate.getSeasonTag(), summerTag, "Season verification failed!");
            log.info("Successfully verified that product "+i+"'s season tag matches the expected tag of "+summerTag);
        }
    }
}
